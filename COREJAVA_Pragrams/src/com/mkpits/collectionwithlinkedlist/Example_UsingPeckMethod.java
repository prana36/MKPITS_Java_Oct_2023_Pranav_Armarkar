...
public class Example_UsingPeckMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println(lt.peek());//it print 1st element of list
		System.out.println(lt.peekLast());//it print last element of list
